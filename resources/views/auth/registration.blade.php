...
<div class="pt-4 pb-4 login">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-4 project_owner">
                    <input type="radio" id="service_provider2" name="type" value="entrepreneur"> <span>صاحب مشروع</span>
    ...
    <div class="py-5 text-left features">
        <div class="container">
            ...
            <div class="pb-3">
                <input type="checkbox">
                <label>قرأت وقبلت سياسة عدم الافصاح وكافة بنود العقد الخاص بها <u> الشروط والأحكام</u>
                    <u>وسياسة
                        الخصوصية</u></label>
            </div>
            <button class="btn btn-primary" href="#">تسجيل </button>
        </div>
    </div>
</form>
@endsection
