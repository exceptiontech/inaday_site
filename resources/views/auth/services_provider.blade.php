        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 pb-5 pb-sm-0 mb-5 mb-sm-0">
                    ...
                    <p>انت كمقدم خدمة، تعتبر حجر الأساس في المنصة، وأنت سبب نجاحها، عشان كذا، دائماً نبحث عن حلول في إنك
                        تكون مرتاح و مبسوط. كل يوم نفكر، كيف تكون منصة D24. هي خيارك الأفضل وخيار كل مبدع و صاحب موهبة، و
                        لذلك ابتكرنا حزمة من المميزات اللي ممكن تلفت انتباهك </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <p>العمل عن بعد هو أسلوب الحياة الجديد، في منصة .انادي. بتكون تشتغل بالوقت اللي يناسبك، وبالقيمة اللي
                    ...
                    <a class="btn btn-primary mt-5"
                        href="{{ url('/account/services') }}">{{ __('file.add_newـservice') }}</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-12 col-md-6">
                    ...
                    @if (Auth::user() && Auth::user()->isServicesProvider())
                        <a class="btn btn-primary mt-3 mb-3"
                            href="{{ url('/account/mixtures/create') }}">{{ __('file.add_newـmixture') }}</a>
                    @else
