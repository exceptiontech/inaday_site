            ...
            <div class="container">
                ...
                <div class="row form-inputs  register-form">
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control required" type="tel" name="mobile" value="{{ old('mobile') }}"  id="phonenumber" required="" onkeyup="this.value=this.value.replace(/[^\d]/,'')" placeholder="5xxxxxxxx">
                    </div>
                    <div class="col-md-4">
