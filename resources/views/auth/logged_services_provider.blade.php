...
<section class="signup new-item">
  <div class="step-app">
    ...
    <form class="formsignup" id="contact" action="{{ route('services_provider_update') }}" method="POST" enctype="multipart/form-data">
      <div>
          ...
          <div class="row">
            ...
            <div class="col-sm-7 leftbox">
                <div class="row">
                  ...
                  <div class="col-sm-6 inpusrach">
                    <label>مهارة أخرى تجيدها<em>*</em></label>
                    <input name="skills[]" class="form-control" type="text" placeholder="مهارة أخرى تجيدها" required>
                  </div>
                </div>
            </div>
          </div>
...
<!--                   <div class="col-sm-6 inpusrach">
 ...
 -->
                ...
                <div class="chicksign">
                  <label class="che-box">
                    <input type="checkbox" id="accepted1" name="check" required="required" ><span class="label-text"> أتعهد أن أعمل بإخلاص وأحافظ على خصوصية واحترام الجميع</span>
                  </label>
                </div>
                <div class="chicksign">
                  <label class="che-box">
                    <input type="checkbox" id="accepted2" name="check"  required="required"><span class="label-text"><em>*</em> قرأت وقبلت سياسة عدم الإفشاء وكافة بنود العقد الخاص بها
