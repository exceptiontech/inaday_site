            ...
            <div class="header-part-right">
                ...
                <div class="dropdown">
                    <div  class="user col align-self-end">
                        @if(Auth::user()->avatar)
                            <img src="{{asset('/'. Auth::user()->avatar)}}" id="userDropdown" alt="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @else
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            <div class="dropdown-header">
                                <i class="i-Lock-User mr-1"></i> {{Auth::user()->fullname ?? Auth::user()->name}}
                            </div>
                            <a href="{{url('/users/'.Auth::user()->id)}}" class="dropdown-item">{{trans('admin.accountsettings')}}</a>
