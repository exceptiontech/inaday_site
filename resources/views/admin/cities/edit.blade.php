            ...
            <div class="box-body">
                ...
                {{ Form::model($city, array('route' => array('cities.update', $city->id), 'method' => 'PUT')) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.editcity')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="tab-pane  @if ($lang == App::getLocale()) fade active show @endif " id="{{$lang}}" role="tabpanel" aria-labelledby="{{$lang}}-icon-pill">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('title['.$lang.']', $city->title[$lang], ['required','class' => 'form-control','autocomplete'=>'off','id'=>'title_'.$lang]) !!}
                                    </div>


                                    <div class="form-group">
                                        {!! Form::label('desc-'.$lang, trans('admin.desc').' - '.$language) !!}
                                        {!! Form::textarea('desc['.$lang.']', $city->desc[$lang], 
                                            array('required', 
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('slug', $city->slug, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@if($city->image) col-sm-9  @endif"> 
                            {!! Form::label('image', trans('admin.image')) !!}
                            {!! Form::file('image', array( 'class' => 'form-control')) !!}
                        </div>
                        @if($city->image)
                        <div class="col-sm-3"> 
                            <img src="{{ url('/'.$city->image) }}" class="img-responsive img-circle" >
                        </div>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('order', $city->order, ['required', 'class' => 'form-control']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::select('is_active', ['1' => trans('admin.yes'), '0' => trans('admin.no')], $city->is_active, ['required', 'class' => 'form-control']) !!}
                    </div>
