            ...
            <div class="box-body">
                ...
                {{ Form::model($article, array('route' => array('articles.update', $article->id), 'method' => 'PUT')) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.editarticle')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="tab-pane  @if ($lang == App::getLocale()) fade active show @endif " id="{{$lang}}" role="tabpanel" aria-labelledby="{{$lang}}-icon-pill">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('title['.$lang.']', $article->title[$lang], ['required','class' => 'form-control','autocomplete'=>'off','id'=>'title_'.$lang]) !!}
                                    </div>


                                    <div class="form-group">
                                        {!! Form::label('desc-'.$lang, trans('admin.desc').' - '.$language) !!}
                                        {!! Form::textarea('desc['.$lang.']', $article->desc[$lang], 
                                            array('required', 
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('slug', $article->slug, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@if($article->image) col-sm-9  @endif"> 
                            {!! Form::label('image', trans('admin.image')) !!}
                            {!! Form::file('image', array( 'class' => 'form-control')) !!}
                        </div>
                        @if($article->image)
                        <div class="col-sm-3"> 
                            <img src="{{ url('/'.$article->image) }}" class="img-responsive img-circle" >
                        </div>
                        @endif
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::select('department_id', $departments->pluck('name.ar','id'), $article->department_id , ['required', 'class' => 'form-control']) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label('order', trans('admin.slug')) !!}
                        {!! Form::text('order', $article->order, ['required', 'class' => 'form-control']) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!!Form::select('is_active', ['1' => trans('admin.yes'), '0' => trans('admin.no')], $article->is_active, ['required', 'class' => 'form-control']) !!}
                    </div>
