    ...
    <div class="row">
        ...
        <div class="box box-warning">
            <div class="box-body">
                ...
                {{ Form::open(['action' => 'Admin\BeneficiaryController@store', 'files'=>true,'novalidate'=>'novalidate']) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.addbeneficiary')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('subtitle-'.$lang, trans('admin.subtitle').' - '.$language ) !!}
                                        {!! Form::text('subtitle['.$lang.']', null, ['required','class' => 'form-control','autocomplete'=>'off','id'=>'title_'.$lang]) !!}
                                    </div>
