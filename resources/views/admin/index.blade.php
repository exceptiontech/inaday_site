...
@section('page-js')
     <script src="{{asset('assets/dashboard/js/scripts/vendor/echarts.min.js')}}"></script>
     <script src="{{asset('assets/dashboard/js/scripts/es5/echart.options.min.js')}}"></script>
     <script src="{{asset('assets/dashboard/js/scripts/es5/dashboard.v1.script.js')}}"></script>
