    ...
    <div class="row">
        ...
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">{{trans('admin.editlevel')}}</h3>
            </div>
            <div class="box-body">
                ...
                {{ Form::model($level, array('route' => array('levels.update', $level->id), 'method' => 'PUT')) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.editlevel')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="tab-pane  @if ($lang == App::getLocale()) fade active show @endif " id="{{$lang}}" role="tabpanel" aria-labelledby="{{$lang}}-icon-pill">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('title['.$lang.']', $level->title[$lang], ['required','class' => 'form-control','autocomplete'=>'off','id'=>'title_'.$lang]) !!}
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('slug', $level->slug, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                    </div>


                    <div class="form-group">
                        {!! Form::label('is_active', trans('admin.status')) !!}
                        {!!Form::select('is_active', ['1' => trans('admin.yes'), '0' => trans('admin.no')], $level->is_active, ['required', 'class' => 'form-control']) !!}
                    </div>
