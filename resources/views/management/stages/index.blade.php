    ...
    <div class="box box-warning">
        <div class="box-header with-border mb-3">
            <h3 class="box-title">
              ...
              <span class="float-right">
                <a class="btn btn-primary" href="{{ url('/admin/stages/create') }}">{{trans('admin.addstage')}}</a>
              </span>
            </h3>
        </div>
        ...
        <div class="box-body">
            ...
            @if (Session::has('message'))
              <div class="alert alert-dismissible alert-{{Session::get('stage')}}">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{trans('admin.stage')}}</th>
                    ...
                    <tbody>
                        @if(count($stages))
                            ...
                            <tr>
                                <td>{{$stage->id}}</td>
                                <td>{{@$stage->title[App::getLocale()] }}</td>
                                <td>{{$stage->slug}}</td>
                                <td>
                                ...
                                <td class="actions" width="200">
                                  <a class="btn btn-info" href="{{ action('Admin\StageController@edit',$stage->id) }}" data-toggle="tooltip" title="{{trans('admin.edit')}}">
                                    {{trans('admin.edit')}}
                                  </a>
                                  {{ Form::open(array('url' => 'admin/stages/' . $stage->id,'style'=>'display:inline')) }}
