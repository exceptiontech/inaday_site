    ...
    <div class="row">
        ...
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">{{trans('admin.editstatus')}}</h3>
            </div>
            <div class="box-body">
                ...
                {{ Form::model($status, array('route' => array('statuses.update', $status->id), 'method' => 'PUT')) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.editstatus')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="tab-pane  @if ($lang == App::getLocale()) fade active show @endif " id="{{$lang}}" role="tabpanel" aria-labelledby="{{$lang}}-icon-pill">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::textarea('desc['.$lang.']', $status->desc[$lang], 
                                            array('required', 
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('slug', $status->slug, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                    </div>
