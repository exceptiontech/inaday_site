    ...
    <div class="row">
        ...
        <div class="box box-warning">
            <div class="box-header">
                <h3 class="box-title">{{trans('admin.editjobtype')}}</h3>
            </div>
            <div class="box-body">
                ...
                {{ Form::model($jobtype, array('route' => array('jobtypes.update', $jobtype->id), 'method' => 'PUT')) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.editjobtype')}}</h4>
                            ...
                            <div class="tab-content" id="myPillTabContent">
                                ...
                                <div class="tab-pane  @if ($lang == App::getLocale()) fade active show @endif " id="{{$lang}}" role="tabpanel" aria-labelledby="{{$lang}}-icon-pill">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('title['.$lang.']', $jobtype->title[$lang], ['required','class' => 'form-control','autocomplete'=>'off','id'=>'title_'.$lang]) !!}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('slug', $jobtype->slug, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {!!Form::select('is_active', ['1' => trans('admin.yes'), '0' => trans('admin.no')], $jobtype->is_active, ['required', 'class' => 'form-control']) !!}
                            </div>
