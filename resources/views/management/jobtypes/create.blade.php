    ...
    <div class="row">
        ...
        <div class="box box-warning">
            <div class="box-body">
                ...
                {{ Form::open(['action' => 'Admin\JobtypeController@store', 'files'=>true,'novalidate'=>'novalidate']) }}
                    ...
                    <div class="card text-left">
                        <div class="card-body">
                            <h4 class="card-title mb-3">{{trans('admin.addjobtype')}}</h4>
                            ...
                            <div class="form-group">
                                {!! Form::label('is_active', trans('admin.jobtype')) !!}
