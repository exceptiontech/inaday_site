          ...
          <div class="row">
            ...
            <div class="col-sm-7 leftbox">
              <div class="row center">
                <div class="col-sm-12"><h3  style="text-align: center; color :#053a68; font-size:24px;font-weight:bolder;line-height:2">{{trans('file.thanks_for_being_ambitious_and_an_entrepreneur')}}</h3></div>
