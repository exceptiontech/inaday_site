...
<section class="banner">
  <div class="container">
    <h1 class="title">{{$booking->service->title}}</h1>
  </div>
</section>
      ...
      <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-sm-8"> 
              <div class="chek-item">
                <div class="innerbox">
                  <h2 class="title">{{$booking->service->title}}</h2>
            ...
            <div class="col-sm-4 chek-item">
              <div class="innerbox text-center">
                ...
                <div class="data-item">
                  <p>{{trans('file.date')}} : {{$booking->service->created_at}}</p>
                  <p>{{trans('file.section')}} : 
                    @if($booking->service->section)
                      {{@$booking->service->section->title[App::getLocale()]}} 
                    @else 
