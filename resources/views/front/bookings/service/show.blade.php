        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 title">
                    <h2 class="text-white mb-5">طلب {{$booking->service->title}}</h2>
                </div>
                        ...
                        <div class="project-info mb-5">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="col-6 p-0"> {{ $booking->service->user->first_name.' '.$booking->service->user->last_name }} </div>
                                </li>
                                <li class="list-group-item d-flex">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 text-right">
                                        <ul class="list-inline">
                                              ...
                                              <div id="socialHolder">
                                                <div id="socialShare" class=" share-group">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                      <li>
                                                        <a data-original-title="Twitter" rel="tooltip"  href="https://twitter.com/share?url={{url('/services/'.$booking->service->title)}}&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons" class="btn btn-twitter" >
                                                      <i class="fa fa-twitter"></i>
                                                    </a>
                                                    </li>
                                                    <li>
                                                      <a target="_blank"  href="http://www.facebook.com/sharer.php?u={{url('/services/'.$booking->service->title)}}" class="btn btn-facebook" >
                                                      <i class="fa fa-facebook"></i>
                                                    </a>
                                                    </li>         
                                                    <li>
                                                      <a  rel="tooltip"  href="https://plus.google.com/share?url={{url('/services/'.$booking->service->title)}}" class="btn btn-google" >
                                                      <i class="fa fa-google-plus"></i>
                                                    </a>
                                                    </li>
                                                      <li>
                                                      <a hhref="http://www.linkedin.com/shareArticle?mini=true&amp;url={{url('/services/'.$booking->service->title)}}" class="btn btn-linkedin" data-placement="left">
                                                    ...
                                                    <li>
                                                      <a  class="btn btn-mail" href="mailto:?Subject=Simple Share Buttons&amp;Body=I%20saw%20this%20and%20thought%20of%20you!%20 {{url('/services/'.$booking->service->title)}}">
                                            ...
                                            <li class="list-inline-item">
                                                @if(Auth::user()->ServicehasFavorite($booking->service->id))
                                                    <a id="RemoveFromFav" class="updateFav updateFav{{$booking->service->id}}" data-id="{{ $booking->service->id}}" href="#" >
                                                    <i class="fa fa-star starred" aria-hidden="true"></i></a>
                                                @else
                                                    <a id="AddToFav" class="updateFav updateFav{{ $booking->service->id}}" data-id="{{ $booking->service->id}}" href="#" >
