                        ...
                        <div class="project-info mb-5">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="col-6 p-0"><span class="">{{ $booking->service->section->title[App::getLocale()] ??  trans('file.without_section') }}</span> </div>
                                </li>

                                <li class="list-group-item d-flex">
                                    <div class="col-6 p-0 text-dark font-weight-bolder">{{trans('file.service_budget')}}</div>
