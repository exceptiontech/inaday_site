                    ...
                    <div class="bg-light rounded pt-3 pb-3 p-2">
                        <div class="author">
                            <div class="col-sm-12 d-flex align-items-center mb-5">
                                ...
                                <div class="ml-2">
                                    <span class="small">{{__('file.the_team')}}</span>
                        ...
                        <div class="project-info mb-5">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex">
                                    ...
                                    <div class="col-6 p-0">{{ $booking->mixture->duration}} {{__('file.hour')}} </div>
                                </li>
                        ...
                        <div class="col-12 contact_author align-bottom">
                            ...
                            @if(Auth::user()->id == $booking->user->id)
                                <a href="{{url('/account/messages/?user_id='.$booking->mixture->team->user->id)}}" class="btn btn-primary btn-block mb-2">{{trans('file.contact_me')}}</a>
                            @else
                    ...
                    <div class="bg-light rounded pt-2 pb-3 p-2">
                        <div class="project">
                            ...
                            <div class="block col-12 pt-3 pb-2 mb-1">
                                <div class="row">
                                    <div class="col-sm-10">
                                       <h2 class="mb-3">{{trans('file.mixture_title')}}</h2>
                            ...
                            <div class="block col-12 pt-3 pb-2 mb-1">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h2 class="mb-3">{{trans('file.mixture_desc')}}</h2>
                            ...
                            <div class="block col-12 pt-3 pb-5 mb-1 border-0">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h2 class="mb-3">{{trans('file.mixture_path')}}</h2>
                                    </div>
                                </div>
                                <div class="row comments">
                                    ...
                                    {!! Form::hidden('mixture_id', $booking->mixture->id, ['required', 'class' => 'form-control', 'readonly' => 'readonly']) !!}
