                ...
                <div class="col-12 col-md-4">
                    <div class="bg-light rounded pt-3 pb-3 p-2">
                        <div class="img mb-3 text-center" >
                          <img class="img-fluid" src="{{ url($project->img ?? '/assets/images/logo.png' )}}" alt="" title="" />
                        ...
                        <div class="project-info mb-5">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex">
                                    <div class="col-6 p-0 text-dark">صاحب المشروع</div>
                                    <div class="col-6 p-0"> {{ $booking->project->user->first_name.' '.$booking->project->user->last_name }} </div>
                                </li>
                                <li class="list-group-item d-flex">
