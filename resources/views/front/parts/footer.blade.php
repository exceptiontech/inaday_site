...
<!--                             @error('password')
                    ...
                    <p class="paragrapgh-login">هذه الخاصية للأعضاء المسجلين بالفعل. في حالة التسجيل يرجى استخدام صفحات التسجيل بالاعلي . في
                        حالة الدخول من خلال جوجل هنا ستكون صاحب عضوية بلا أي صلاحيات </p>
