                                              ...
                                              <div id="socialHolder">
                                                <div id="socialShare" class=" share-group">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                      <li>
                                                        <a data-original-title="Twitter" rel="tooltip"  href="https://twitter.com/share?url={{url('/services/'.$service->title)}}&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons" class="btn btn-twitter" >
                                                    ...
                                                    <li>
                                                      <a  rel="tooltip"  href="https://plus.google.com/share?url={{url('/services/'.$service->title)}}" class="btn btn-google" >
                                                      <i class="fa fa-google-plus"></i>
                                                    </a>
                                                    </li>
                                                      <li>
                                                      <a hhref="http://www.linkedin.com/shareArticle?mini=true&amp;url={{url('/services/'.$service->title)}}" class="btn btn-linkedin" data-placement="left">
