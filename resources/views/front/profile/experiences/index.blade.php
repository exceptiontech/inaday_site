                                    ...
                                    <div class="cv-history">
                                        @if (count(Auth::user()->experiences))
                                            ...
                                            <div class="cv-item pl-3 pb-3">
                                                ...
                                                <p class="date mb-1">
                                                    {{$experience->company}} من <span>{{ Carbon\Carbon::parse(strtotime($experience->start_date))->format('m-Y') }} </span>  الي <span> {{ Carbon\Carbon::parse(strtotime($experience->end_date))->format('m-Y ') ?? 'الان'}} </span>
                                                </p>
                                                <p class="details">
                                                    {{$experience->desc ?? ''}}
                                                </p>
