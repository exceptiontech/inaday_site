...
return [
    ...
    */
    ...
    'and_establishing_successful_business' => 'وتأسيس أعمال تجارية ناجحة',
    'practical_training' => 'التدريب العملي المنتهي بالتوظيف',
    'ended_in_employment' => 'المنتهي بالتوظيف',
    'the_possibility_of_forming_a_team_and_shop_to_enter' => 'إمكانية تكوين فريق و متجر للدخول على مشاريع و فرص أكبر',
    'the_possibility_of_forming_a_team_and_shop_to_enter_desc' => 'يمكنك من خلال المنصة التدريب العملي الذي يؤهلك فيما بعد إلى التوظيف وممارسة ما قمت بالتدرب عليه',
    ...
    'experience_certificate_for_immediate_accomplishments' => 'شهادة خبرة للإنجازات ال
فورية',
    ...
    'choose' => 'اختر',
    'password_is_not_less_than_8_characters' => 'كلمة المرور لا تقل عن ٨ أحرف إنجليزية ولا بد ان تحتوي على الرموز @$!%*#?& أحرف كبيرة وصغيرة وأرقام',
    ...
    // 'start_your_project' => 'مقدم خدمة',
    'service_provider_desc' => 'هو كل موهوب أو متخصص عندة الرغبة بالتعلم وتطوير مهاراته وتقديمها كخدمة تساعد أصحاب الأعمال فى تأسيس مشاريعهم وتنفيذ أعمالهم بأقل الأسعار',
    'new_entrepreneurs' => 'رواد الأعمال الجدد',
    'owne_entrepreneurs' => 'صاحب المشروع',
    'entrepreneur_desc' => 'هو كل مبادر وصاحب فكرة وعزيمة و لدية حلم فى بدء أعمال تجارية، تخدمه وتخدم مجتمعه وتكون سبب فى خلق الوظائف ويكون ملهم و قدوة لجيل الرؤية',
    ...
    'we_offer_you_complete_solutions_desc3' => 'ممتع؟ إذا تعتقد إنك موهوب وتحب الشغل جرب أحسب دخلك',
    ...
    'booking_servives' => ' حجز خدمة',
    'booking_mixtures' => ' حجز خلطة',
    'booking_servives_provider' => ' حجز مقدم خدمة',
    ...
    'entrepreneurs_training' => ' تدريب رواد الأعمال',
    'students' => ' الطلاب',
    'gaming_leaders' => ' قادة الألعاب',
    'myarea' => ' منصتي',
    'top_ten' => ' أفضل 10',
    'more' => ' المزيد',
    ...
    'no_offer_at_this_time'=>'لايوجد أي عروض حالياَ',
    'date'=>'التاريخ',
    'section'=>'القسم',
    ...
    'we_will_contact_you_soon..' => 'ًبنتواصل معك قريبا',
    'return_to_home_page' => 'العودة للرئيسية',
    'you_are_a_service_provider_know_service_delivery_and_can_determine_all_project_requirements_from_time_to_cost' => 'أنت  مقدم خدمة وقادر تحدد كل متطلبات المشروع من وقت وتكلفة.',
    ...
    'please_enter_your_e_mail?' => 'من فضلك ادخل الإيميل الخاص بك',
    'processing_is_in_progress' => 'جاري المعالجة ...',
    'signing_in' => 'جاري تسجيل الدخول',
    'sign_in_successful' => 'تم تسجيل الدخول بنجاح',
    'sorry_the_email_or_password_are_incorrect' => 'عفوا الإيميل أو الباسورد غير صحيحين.',
    'important_links' => 'روابط مهمة',
    'refund_and_cancellation_policy' => 'سياسة الاسترداد والإلغاء',
    'folow_us' => 'تابعونا على',
    'subscribe_now' => 'اشترك الآن',
    'available_payment_methods' => 'وسائل الدفع المتاحة',
    'register_your_email_to_subscribe_to_the_mailing_list_to_receive_all_new' => 'سجل بريدك الإلكتروني للاشتراك بالقائمة البريدية ليصلك كل جديد',
    ...
    'there_are_no_projects' => 'لايوجد مشاريع',
    'apply_now' => 'تقدم الآن',
    ...
    //Errors
    'nothavepermissions'=>'لاتملك الصلاحيات',
    'please_contact_us'=>'من فضلك اتصل بالإدارة',
   ...
   'add_user_to_team'=>'تم إرسال دعوة لمقدم الخدمة لفريقك',
   ...
   'no_skills'=>'لاتوجد مهارات مضافة',
   'notfound'=>'الصفحة غير موجودة أو ليس لديك الصلاحيات',
   ...
   'no_replays'=>'لايوجد تعليقات حتى الآن',
   ...
   'search' => 'بحث',
   'results' => 'نتائج البحث',
   'no_results' => 'لايوجد أي تطابق نتائج',

   //verify

   'verify' =>'تفعيل العضوية',
   'before_verify'=>'من فضلك تأكد من وجود رابط التفعيل في بريدك الإلكتروني ',
   ...
   'fresh_verify'=>'تم إرسال بريد جديد بمعلومات التفعيل',
    ...
    'no_notifications' => 'لايوجد اي إشعارات حالية',
