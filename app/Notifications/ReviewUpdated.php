...
class ReviewUpdated extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->line(__('notification.ReviewUpdatedEmail'))
                    ->action(__('notification.click_here'), url('/'))
                    ->line(__('notification.ReviewUpdatedDescEmail'));
    }
    ...
    public function toDatabase($notifiable)
    {
        return [
            ...
            'title'=> __('notification.ReviewUpdated'),
            'desc'=>__('notification.ReviewUpdatedDesc'),
        ];
    }
    /**
