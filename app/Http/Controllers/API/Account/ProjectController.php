...
class ProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        $projects = Project::where('user_id',Auth::user()->id)->with('skills','section','ModelLogs','offers','offers.user','offers.user.userdetails','offers.team','ConfirmOffer')->paginate(10);
